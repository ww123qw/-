...
$(document).ready(function(){
  ...
  <body>
    ...
    <div class="top">
      <div class="dsjtit">
        <h3 class="street"><span id="namedw"></span> </h3>
        ...
        $.ajax({
    		...
    		success:function(data){
                ...
                //var mm ="M"+${mont};
                 ...
                 // console.log(urh);
                 <%--  <%=path%>/Party_brench?code=${child_info.code} --%>
...
<div class="sunshineabgwe">
  ...
  <div class="zhoner">
    ...
    <div class="bd">
      <ul>
          <%-- <li>
          <div class="pic"><img src="<%=path%>/asset/imagedw/timg.jpg" /></div>
        ...
        <li><div class="pic"><a href="" target="_blank"><img src="<%=path%>/asset/imagedw/timg.jpg" /></a></div><div class="title"><a href="" target="_blank">图片标题</a></div></li>   --%>
      </ul>
      <script type="text/javascript">
...
<div class="younmk fr">
      ...
      <c:forEach var="child_info" items="${list_zz }" >
						<c:choose>
						 ...
						 <%--  <li><img src="<%=path%>/asset/imagedw/jmzd.jpg"><span>南外社区党支部</span></li> --%>
						   ...
						   <c:when test="${child_info.type_id=='613'}">  
						 
						 <li><img src="<%=path%>/asset/imagedw/danghui.png"> <a href="<%=path%>/General_party_brench?code=${child_info.code}&type=${child_info.type_id}" style="display: block;padding: 0;"> <span>${child_info.name }</span></a> </li>
  ...
  <div class="younsa">
    <h2>党委每月登录人数</h2>
    <span >${time}</span>
    <div id="bgtmoe" style="height: 195px;margin-left: 16px;"></div>
...
var img;
  ...
  $('#about').on('click', function(){
	  ...
	  if($('#namedw').text()=='赣江街道党工委'){
			

			 img='<img src="<%=path%>/asset/imagedw/map5.jpg" width="1200px" heigth="670px">';
			 layer.open({
			      type: 1,
			      title: '全域党建图页',
			      maxmin: true,
